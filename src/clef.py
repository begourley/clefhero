# My first Pi-Programming experience
...
def draw():
    ...
    screen.draw.text("Clef", (310,180), color="blue", fontsize=120)
    screen.draw.text("Clef", (310,175), color="white", fontsize=120)
